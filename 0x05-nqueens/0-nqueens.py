...
def is_attacking(pos0, pos1):
    ...
    Args:
        pos0 (list of integers): The position of the first queen.
        pos1 (list of integers): The position of the second queen.
    Returns:
        bool: True if they are attacking each other, otherwise False.
    """
...
def group_exists(group):
    ...
    Args:
        group (list of lists of integers): The group of positions to check.
    Returns:
...
def build_solution(row, group):
    """
    Builds a solution to the N queens problem.
    Args:
...
def get_solutions():
    """
    Gets the solutions to the N queens problem.
    """
    global pos, n
